...
def ProcessTargetFiles(input_tf_zip, output_tf_zip, misc_info,
  ...
  board_prebuilt_vendorimage = misc_info.get("board_prebuilt_vendorimage") == 'true'
  for info in input_tf_zip.infolist():
    filename = info.filename
    if filename.startswith("IMAGES/") and not (filename.endswith("vendor.img") and board_prebuilt_vendorimage):
      continue

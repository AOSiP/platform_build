...
@echo -e ${CL_GRN}"$($(PRIVATE_PREFIX)DISPLAY) StaticLib:${CL_RST}" $(PRIVATE_MODULE) ($@)"
@mkdir -p $(dir $@)
@rm -f $@ $@.tmp
...
@echo -e ${CL_GRN}"$($(PRIVATE_PREFIX)DISPLAY) SharedLib:"${CL_RST}" $(PRIVATE_MODULE) ($@)"
@mkdir -p $(dir $@)
...
@echo -e ${CL_GRN}"$($(PRIVATE_PREFIX)DISPLAY) Strip:"${CL_RST}" $(PRIVATE_MODULE) ($@)"
@mkdir -p $(dir $@)
...
@echo -e ${CL_GRN}"$($(PRIVATE_PREFIX)DISPLAY) Strip (keep symbols):"${CL_RST}" $(PRIVATE_MODULE) ($@)"
@mkdir -p $(dir $@)
...
@echo -e ${CL_GRN}"$($(PRIVATE_PREFIX)DISPLAY) Executable:"${CL_RST}" $(PRIVATE_MODULE) ($@)"
@mkdir -p $(dir $@)
...
@echo -e ${CL_GRN}"$($(PRIVATE_PREFIX)DISPLAY) StaticExecutable:"${CL_RST}" $(PRIVATE_MODULE) ($@)"
@mkdir -p $(dir $@)
...
@echo "$($(PRIVATE_PREFIX)DISPLAY) "${CL_CYN}"Prebuilt: $(PRIVATE_MODULE) ($@)"
$(copy-file-to-target)
endef
